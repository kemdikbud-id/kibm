...
<html lang="id">
	<head>
		...
		<title>Dosen - Kompetisi Inovasi Bisnis Indonesia</title>
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="container">
				<div class="navbar-header">
					...
					{if $ci->session->user}
						<a class="navbar-brand" href="{site_url('home')}">KIBM Dosen</a>
					{else}
						<a class="navbar-brand" href="{base_url()}">KIBM Dosen</a>
					{/if}
				</div>
				<div id="navbar" class="collapse navbar-collapse">
					{if $ci->session->user}
						<ul class="nav navbar-nav">
							<li>
								<a href="{site_url('pendampingan')}">Pelaporan Pendampingan</a>
							</li>
						</ul>
						<ul class="nav navbar-nav navbar-right">
							{if $ci->session->user}
								<li>
									<a href="{site_url('auth/logout')}">Logout ({$ci->session->user->dosen->nama})</a>
								</li>
							{/if}
						</ul>
					{/if}
