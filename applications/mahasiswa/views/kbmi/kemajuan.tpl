...
{block name='content'}
	<div class="panel panel-default">
		<div class="panel-body">
			...
			<h2 class="page-header">Upload Laporan Kemajuan</h2>

			<h5>Batas waktu upload laporan kemajuan mulai <strong>{$kegiatan->tgl_awal_upload_kemajuan_dmy}</strong>
				sampai <strong>{$kegiatan->tgl_akhir_upload_kemajuan_dmy}</strong>
			</h5>
			...
			<form action="{current_url()}?id={$proposal->id}" method="post" enctype="multipart/form-data">
				...
				<fieldset>
					...
					<div class="form-group" style="{if $syarat->fp_id != ''}display: none{/if}" id="fg-upload">
						<label class="control-label">File Laporan Kemajuan</label>
